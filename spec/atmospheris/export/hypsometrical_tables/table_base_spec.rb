...
# require "spec_helper"
# require_relative "../../../../lib/atmospheris"

# RSpec.describe Atmospheris::Export::Iso25331985::TableOne do
#   let(:table_one) { described_class.new }
#   let(:mock_row) do
#     {
#       "pressure-mbar" => 10.0,
#       "geopotential-altitude-m" => 500,
#     }
#   end
...
#       subject
#       expect(table_one.rows).to all(be_a(Atmospheris::Export::Iso25331985::TableOneAttrs))
...
#         subject
#         expect(table_one.rows.first.pressure_mbar).to eq(mock_row["pressure-mbar"])
#         expect(table_one.rows.first.geopotential_altitude).to eq(mock_row["geopotential-altitude-m"])
#       end
#     end
#   end
# end
