...
task :clean do
  ...
  FileUtils.rm_rf "spec/fixtures/iso-2533-2024/yaml"
end
...
generate_2024_subtasks = [
  "spec/fixtures/iso-2533-2024/yaml",
]

directory "spec/fixtures/iso-2533-2024/yaml"
...
%w[
  ...
  filename = "spec/fixtures/iso-2533-2024/yaml/#{name}.yaml"
  file filename do |t|
    File.write(t.name,
               Atmospheric::Export::Iso25332024.send(name.to_sym).to_yaml)
  end
  generate_2024_subtasks << filename
end

task generate_2024: generate_2024_subtasks
